...
namespace dynamicCubeMap
{
	...
	public:
		...
		inline void SetPerObject(const PerObject& perObject);
		inline void SetPerFrame(const PerFrame& Frame);
	...
	void Basic32::SetPerObject(const Basic32::PerObject& perObject)
	{
		mPerObject = perObject;
	}
	void Basic32::SetPerFrame(const Basic32::PerFrame& perFrame)
	{
		mPerFrame = perFrame;
	}
