...
namespace normalDisplacementMap
{
	...
	public:
		...
		inline ID3D11Buffer* GetPerObjectCB() const;
		inline ID3D11Buffer* GetPerFrameCB() const;
	...
	ID3D11Buffer* Basic32::GetPerObjectCB() const
	{
		return mPerObjectCB;
	}
	ID3D11Buffer* Basic32::GetPerFrameCB() const
	{
		return mPerFrameCB;
	}
}